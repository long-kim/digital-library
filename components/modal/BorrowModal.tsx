                ...
                <Box className={classes.modal} style={modalStyle}>
                    <Box>
                        <Box className={classes.btnContainer}>
                            <Button variant='contained' className={`${classes.btn} ${classes.containedBtn}`} onClick={handleAdd}>Thêm vào tủ sách</Button>
                            <Button variant='outlined' className={`${classes.btn} ${classes.outlinedBtn}`} onClick={handleShare}>Chia sẻ lên Facebook</Button>
                        </Box>
                        <Typography variant='h6'>Các thành viên đang chia sẻ</Typography>
                        <Typography className={classes.textLowOpacity}>Hiện có {list.length} thành viên sẵn sàng cho bạn mượn cuốn sách này</Typography>
                        <Box className={classes.borrowerContainer}>
                            {renderBorrower}
                        </Box>
                    </Box>
                </Box>
