...
const reviewList = [
    {
        ava: "https://scontent.fsgn1-1.fna.fbcdn.net/v/t1.0-9/s960x960/74443688_2387688291469423_6786064012900564992_o.jpg?_nc_cat=100&_nc_ohc=rMsccGHD9w0AQnU7Vlu8mAB5VRcugTbk-TA09KLB3spkfF8Xc31qCVF7g&_nc_ht=scontent.fsgn1-1.fna&oh=99a82a9d3d8844fbf955af48ce53421a&oe=5E7EF970",
        name: "Thinh Tran",
        rate: 4,
        review: "However, they commented that it did tend to lag, especially at the end where two bad guys"
    },
    {
        ava: "https://scontent.fsgn1-1.fna.fbcdn.net/v/t1.0-9/s960x960/74443688_2387688291469423_6786064012900564992_o.jpg?_nc_cat=100&_nc_ohc=rMsccGHD9w0AQnU7Vlu8mAB5VRcugTbk-TA09KLB3spkfF8Xc31qCVF7g&_nc_ht=scontent.fsgn1-1.fna&oh=99a82a9d3d8844fbf955af48ce53421a&oe=5E7EF970",
        name: "Thinh Tran",
        ...
        <div className={classes.body}>
            <div className={classes.top}>
                <div className={classes.detail}>
                    <div>
                        <div className={classes.book_name}>Harry Potter: và chiếc cốc lửa</div>
                        <p>J.K. Rowling</p>
                        ...
                        Harry Potter and the Goblet of Fire is a fantasy book written by British author J. K. Rowling 
    and the fourth novel in the Harry Potter series. It follows Harry Potter, a wizard in his fourth 
    year at Hogwarts School of Witchcraft and Wizardry, and the mystery surrounding the entry 
    of Harry's name into the Triwizard Tournament, in which he is forced to compete.
    The book was published in the United Kingdom by Bloomsbury and in the United States by 
    Scholastic. In both countries, the release date was 8 July 2000. This was the first time a book 
    in the series was published in both countries at the same time. 
                ...
                <div className={classes.imgs}>
                    ...
                    <div className={classes.side}>
                        <img className={classes.side_img} src="https://images-na.ssl-images-amazon.com/images/I/810BkqRP%2BiL.jpg"></img>
                        <img className={classes.side_img} src="https://images-na.ssl-images-amazon.com/images/I/810BkqRP%2BiL.jpg"></img>
                        <img className={classes.side_img} src="https://images-na.ssl-images-amazon.com/images/I/810BkqRP%2BiL.jpg"></img>
                    </div>
                </div>
            ...
            <div className={classes.bot}>
                ...
                <div className={classes.right}>
                    ...
                    <div className={classes.related_books}>
                        {renderBooks}
                    </div>
                </div>
            </div>
